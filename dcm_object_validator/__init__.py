...
This flask app implements the 'Object Validator'-API (see
`openapi.yaml` in the sibling-package `dcm_object_validator_api`).
"""
...
from dcm_object_validator.views import ValidationView
...
def app_factory(
    ...
    app.extensions["orchestra"] = extensions.orchestra_loader(
        app, config, config.worker_pool, "Object Validator", as_process
    )
